...
Data egress to a PI server creates a PI point in the AVEVA adapter configuration. Data egress to ADH creates a stream in the AVEVA adapter configuration.
